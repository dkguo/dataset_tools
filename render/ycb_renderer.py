...
if __name__ == '__main__':
    ...
    obj_paths = ['/home/gdk/Data/kitchen_sink/models/{}/textured_simple.obj'.format(item) for item in models]
    texture_paths = ['/home/gdk/Data/kitchen_sink/models/{}/texture_map.png'.format(item) for item in models]
