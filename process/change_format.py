...
def change_old_to_new_data_format(old_scene_path):
    ...
    for i, camera_name in enumerate(old_camera_names):
        new_camera_name = f'camera_{i+1:02d}'
...
if __name__ == '__main__':
    paths = ['/home/gdk/data/1660754262',
             '/home/gdk/data/1661444331_apriltag',
             '/home/gdk/data/1661444356_cup',
    '/home/gdk/data/1661444381_bowl',
    '/home/gdk/data/1661444514_apriltag',
    '/home/gdk/data/1661444540_pitcher',
    '/home/gdk/data/1661445017']
